        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('maregla') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <?php
                                foreach($obj as $ob) {
                                    foreach ($ob->events as $obb => $obbd) {
                                        $d = $obb;
                                    }
                                }
                                if(isset($d)==false) $d=0;
                                ?>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="precondition" type="text" class="form-control" name="precondition" value="{{ $obj[0]->precondition }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="regla" type="text" class="form-control" name="regla" value="{{ $obj[0]->configurations[0]->name }}">
